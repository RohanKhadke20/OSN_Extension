...
Detailed architecture decision records are available in [docs/DECISIONS.md](docs/DECISIONS.md).
...
### Added
- Authoritative continuous security & dependency research baseline in [docs/RESEARCH.md](docs/RESEARCH.md).
- Comprehensive Architecture Decision Records (ADRs 001–006) in [docs/DECISIONS.md](docs/DECISIONS.md).
- Exhaustive module and IPC interface reference in [docs/API_REFERENCE.md](docs/API_REFERENCE.md).
- Developer onboarding and local multi-browser extension loading guide in [docs/DEVELOPMENT.md](docs/DEVELOPMENT.md).
- Community health files: [CONTRIBUTING.md](CONTRIBUTING.md), [CODE_OF_CONDUCT.md](CODE_OF_CONDUCT.md), [LICENSE](LICENSE), and `.github/ISSUE_TEMPLATE/*`.

### Changed
- Synchronized all documentation ([docs/COMPATIBILITY.md](docs/COMPATIBILITY.md), [docs/PROJECT_ENGINEERING_BASELINE.md](docs/PROJECT_ENGINEERING_BASELINE.md), [docs/ROADMAP.md](docs/ROADMAP.md), root [README.md](README.md), and [PROJECT.md](PROJECT.md)) to eliminate architectural drift and reflect the current `src/` modular layout and 241 unit test suite.
