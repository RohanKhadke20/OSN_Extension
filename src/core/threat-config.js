/**
 * OSN Guard - Canonical Threat Configuration
 *
 * Single source of truth for all threat rules, signatures, and thresholds used
 * by the URL, PII, and Scam analyzers.  Deep-frozen and prototype-pollution safe.
 *
 * Analyzers consume this via their optional `userConfig` factory parameter:
 *
 *   const { analyzeUrlSafety } = OSNUrlAnalyzer(myOverrides);
 *
 * When no override is supplied the returned DEFAULT_THREAT_CONFIG values are
 * used verbatim, preserving 100 % backwards-compatible default behaviour.
 *
 * JSON-serialisable — all values are plain strings, numbers, booleans, or
 * arrays thereof (no Set / Map / RegExp at the top level).
 * Analyzers convert arrays to Sets / compile RegExps internally.
 */
...
(function (root, factory) {
  if (typeof module === "object" && module.exports) {
    ...
    root.OSNThreatConfig = factory();
  }
})(typeof self !== "undefined" ? self : this, function () {
  "use strict";

  // ---------------------------------------------------------------------------
  // Utility: deep-freeze a plain object tree
  // ---------------------------------------------------------------------------
  ...
  const URL_CONFIG = {
    ...
    dangerousSchemes: ["data:", "blob:", "file:", "filesystem:"],
    dangerousExtensions: [
    ...
    rules: [
      {
        ...
        severity: "critical",
        keywords: [
          "free crypto", "crypto giveaway", "bitcoin doubled",
          "double your bitcoin", "send eth", "send btc to",
          "airdrop claim", "claim your airdrop",
          "guaranteed returns up to", "eth bonus",
      ...
      },
      {
        ...
        severity: "critical",
        keywords: [
          "enter seed phrase", "enter secret recovery phrase",
          "secret recovery phrase", "recovery phrase", "seed phrase",
          "12-word recovery phrase", "24-word recovery phrase",
          "12 word recovery phrase", "24 word recovery phrase",
          "12-word seed phrase", "24-word seed phrase",
          "12 word seed phrase", "24 word seed phrase",
          "backup recovery phrase", "backup seed phrase",
          "import recovery phrase", "import your recovery phrase",
          "import your seed phrase", "enter your seed phrase",
          "input recovery phrase", "input seed phrase",
          "input your recovery phrase", "input your seed phrase",
          "provide recovery phrase", "provide your recovery phrase",
          "share your recovery phrase", "share your seed phrase",
          "verify recovery phrase", "verify your recovery phrase",
          "restore wallet with recovery phrase",
          "restore wallet with seed phrase",
          "restore wallet with seed",
          "mnemonic recovery phrase", "mnemonic seed phrase",
          "enter mnemonic phrase", "enter your mnemonic",
          "type your 12 words", "type your 24 words",
          "enter your 12 words", "enter your 24 words",
          "fake recovery phrase", "leaked recovery phrase",
          "accidental recovery phrase", "wallet recovery phrase",
          "here is my recovery phrase", "here is my 12-word phrase",
          "here is my 12 word phrase", "here is my 12-word seed",
          "here is my 12 word seed", "connect wallet to claim",
          "wallet verification required", "metamask verification",
          "trust wallet restore", "sync wallet to resolve",
          "validate your private key"
        ],
        patterns: [
          "\\b(?:enter|input|import|verify|restore|submit|provide|share|backup)\\s+(?:your\\s+)?(?:secret\\s+)?(?:12|24)[\\s-]*words?\\b",
          "\\b(?:12|24)[\\s-]*(?:word|mnemonic)[\\s-]*(?:recovery|seed)[\\s-]*phrase\\b",
          "\\b(?:fake|leaked|accidental|abandoned|unclaimed)\\s+(?:wallet\\s+)?(?:seed|recovery|mnemonic)\\s+phrase\\b",
          "\\bhere\\s+is\\s+my\\s+(?:12|24)[\\s-]*(?:word\\s+)?(?:seed|recovery)\\b"
        ],
      ...
      },
      {
        ...
        severity: "critical",
        keywords: [
          "verify account", "unusual activity detected",
          "reset credentials now", "suspicious access login",
          "account suspension warning", "log in within 24 hours",
      ...
      },
      {
        ...
        severity: "critical",
        keywords: [
          "call microsoft support", "contact apple support at",
      ...
      },
      {
        ...
        severity: "warning",
        keywords: [
          "whatsapp contact", "contact our whatsapp",
          "earn daily", "work from home scam",
          "click here to earn", "telegram channel join",
          "join our telegram channel", "earn $500/day",
          "easy money from home", "passive income guaranteed"
        ],
      ...
      },
      {
        ...
        severity: "warning",
        keywords: [
          "amazon gift card giveaway", "won a free gift card",
          "claim $1000 prize", "wire transfer immediately",
          "pay via western union", "moneygram fee to claim"
        ],
      ...
      },
      {
        ...
        severity: "critical",
        keywords: [
          "scan qr code to verify", "scan this qr code to log in",
          "scan qr to login", "scan the qr code to receive payment",
          "scan qr code to update payment", "scan to unlock your account",
          "scan qr code to configure 2fa", "scan qr code to set up 2fa",
          "scan qr code to enable 2fa",
          "scan qr code for two-factor authentication",
          "scan qr code for 2fa", "scan qr to update 2fa",
          "scan qr code to register authenticator",
          "scan qr code for authenticator app",
          "scan qr for authenticator", "scan qr to authenticate session",
          "scan qr code with your phone camera",
          "scan qr code with mobile camera", "point camera at qr code",
          "point your camera at the qr code",
          "point phone camera at qr code",
          "scan qr code with your smartphone",
          "scan qr code with mobile device",
          "scan qr with your mobile device",
          "scan qr with phone to continue", "scan this qr with your phone",
        ...
        patterns: [
          "\\bscan\\s+(?:the\\s+|this\\s+)?qr[\\s-]*(?:code)?\\s+(?:with\\s+(?:your\\s+)?(?:phone|mobile|smartphone)(?:\\s+camera)?|to\\s+(?:configure|enable|set\\s+up|update)\\s+2fa)\\b",
          "\\b(?:point|aim)\\s+(?:your\\s+)?(?:phone\\s+|mobile\\s+)?camera\\s+at\\s+(?:the\\s+|this\\s+)?qr[\\s-]*(?:code)?\\b",
          "\\bscan\\s+(?:the\\s+|this\\s+)?qr[\\s-]*(?:code)?\\s+to\\s+(?:release\\s+pending\\s+emails|retain\\s+password|prevent\\s+password\\s+expiration|view\\s+(?:your\\s+)?payslip|access\\s+w-?2|approve\\s+refund)\\b"
        ],
      ...
      },
      {
        ...
        severity: "critical",
        keywords: [
          "stealth drop is live", "free mint is live",
          "mint your free nft", "claim free nft whitelist",
      ...
      },
      {
        ...
        severity: "warning",
        keywords: [
          "claim free ai tokens", "chatgpt tokens giveaway",
          "invest in ai compute", "ai arbitrage bot guaranteed",
          "daily passive crypto yield", "guaranteed 50% weekly return"
        ],
      ...
      },
      {
        ...
        severity: "critical",
        keywords: [
          "package delivery failed", "parcel pending delivery",
          "reschedule delivery fee", "update delivery address",
          "customs fee unpaid", "shipment held at depot",
          "usps delivery issue", "redelivery scheduled fee"
        ],
      ...
      },
      {
        ...
        severity: "warning",
        keywords: [
          "earn commission for rating", "complete daily tasks to earn",
          "paid per video review", "daily task commission",
          "app review job daily pay", "recharge wallet to unlock commission"
        ],
      ...
      },
      {
        ...
        severity: "critical",
        keywords: [
          "move to whatsapp my dear", "chat on whatsapp instead",
          "my uncle teaches me crypto", "uncle works in finance",
          "guaranteed crypto trading platform",
          "invest together on this platform",
          "my financial advisor helps me trade",
          "teach you how to trade gold", "exclusive liquidity pool",
          "let's talk on telegram handsome",
          "let's chat on telegram honey", "my private whatsapp number"
        ],
      ...
      },
      {
        ...
        severity: "critical",
        keywords: [
          "geek squad renewal", "mcafee subscription renewed",
          "norton auto-renewal", "charged your account $399",
          "charged your account $499", "auto-debit of $",
          "call to cancel subscription", "call to dispute this charge",
          "invoice attached call", "call toll-free to refund",
      ...
      },
      {
        ...
        keywords: [
          ...
          "urgent bail money", "need money urgently please send",
      ...
      },
      {
        ...
        severity: "critical",
        keywords: [
          "permit2 batch", "sign permit2", "permit2 signature",
          "setapprovalforall", "increaseallowance", "sign eth_sign",
          "sign this message to verify wallet",
          "sign message to claim airdrop", "approve unlimited",
  ...
  // ---------------------------------------------------------------------------
  // Assemble and deep-freeze the canonical config
  // ---------------------------------------------------------------------------
  const DEFAULT_THREAT_CONFIG = deepFreeze({
    url: URL_CONFIG,
    pii: PII_CONFIG,
    scam: SCAM_CONFIG
  });

  return { DEFAULT_THREAT_CONFIG, deepFreeze };
});
